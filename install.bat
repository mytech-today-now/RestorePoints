@echo off
REM ============================================================================
REM  myTech.Today - Restore Points Manager Setup
...
:RUN_INSTALLER
echo.
echo [INFO] Running Restore Points Manager...
echo.

pwsh -NoProfile -ExecutionPolicy Bypass -File "%~dp0Manage-RestorePoints.ps1" %*
